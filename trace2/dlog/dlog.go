...
func (l *Logger) LogDepth(s Severity, depth int, args ...interface{}) {
	l.printDepth(s, depth+1, args...)
}

func (l *Logger) LogDepthf(s Severity, depth int, format string, args ...interface{}) {
...
func LogDepthV2(l Logger, s Severity, depth int, args ...interface{}) {
	l.printDepth(s, depth+1, args...)
}

func LogDepthfV2(l Logger, s Severity, depth int, format string, args ...interface{}) {
	l.printfDepth(s, depth+1, format, args...)
}
